	...
	<div class="ts-main-content">
		<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li><a href="tables.html"><i class="fa fa-table"></i> Konsumen</a></li>
				<li><a href="forms.html"><i class="fa fa-edit"></i> Karyawan</a></li>
				<li><a href="charts.html"><i class="fa fa-pie-chart"></i> Transaksi</a></li>
